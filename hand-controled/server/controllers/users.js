const {signUpSchema, signInSchema ,userIdValidation, updateUserSchema} = require('../lib/validation/users');
const { z } = require('zod');
...
const signUp = async (req, res) => {
    try {
        ...
        setTokenCookie(res, username, hashedPassword, process.env.JWT_SECRET)
...
const signIn = async (req,res) => {
    try{
        ...
        setTokenCookie(res, username, user.password, process.env.JWT_SECRET)
